...
export default function Footer() {
  return (
    <footer className="footer-container">
        ...
        <div className="container px-4 py-4">
          <div className="footer-disclaimer">
            <p className="footer-disclaimer-text">
              Disclaimer: example.com is an independent informational platform with no association or affiliation with any government body. All data and updates shared on this website are compiled from official government notifications, press releases, and reputable public sources. While we strive to ensure accuracy, we do not guarantee completeness or timeliness. Users should confirm all details from official websites before proceeding.
            </p>
          </div>
      ...
      {/* Lower Section - Primary Color (Dark Purple replaced) */}
      ...
      {/* Bottom Lines */}
      <div className="footer-bottom-lines">
